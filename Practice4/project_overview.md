...
│   │   ├── pages/
│   │   │   ├── UsersListPage.tsx  # Список користувачів
│   │   │   ├── UserCreatePage.tsx # Створення
│   │   │   ├── UserEditPage.tsx   # Редагування
│   │   │   └── UserViewPage.tsx   # Перегляд профілю
│   │   ├── App.tsx                # Кореневий компонент + маршрути
