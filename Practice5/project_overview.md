...
│   │   ├── state/                 # Керування станом (Context / Reducer / Hooks)
│   │   │   ├── usersReducer.ts    # Структура стану, типи дій, чистий редуктор
│   │   │   ├── UsersContext.tsx   # React Context + Provider для поширення стану
│   │   │   ├── useUsers.ts        # Хук: доступ до стану + координація API
│   │   │   └── useDepartments.ts  # Хук: завантаження та кешування відділів
...
│   │   ├── App.tsx                # Кореневий компонент + маршрути + UsersProvider
